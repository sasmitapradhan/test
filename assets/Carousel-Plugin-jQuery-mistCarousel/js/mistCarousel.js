...
(function() {
	...
	Mistify.prototype.appendMasks = function() {
		...
		var maskDom = '' +
			'<div class="mistify__mask-container">' +
				'<div class="mistify__mask mistify__mask--active"><img src="/assets/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-1.png" alt="Mask"/></div>' +
				'<div class="mistify__mask"><img src="/assets/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-2.png" alt="Mask"/></div>' +
				'<div class="mistify__mask"><img src="/assets/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-3.png" alt="Mask"/></div>' +
				'<div class="mistify__mask"><img src="/assets/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-4.png" alt="Mask"/></div>' +
			'</div>';
			...
			var infoDom = '' +
				'<li class="mistify__info">' +
					'<a class="mist-link" href="' + _.props.elem.find('.mistify__slide:nth-child(' + (i + 1) + ') .mistify__slide-content').attr('href') + '">' +
						'<p class="mistify__info-description">' + _.props.elem.find('.mistify__slide:nth-child(' + (i + 1) + ') .mistify__slide-description').html() + '</p>' +
						'<h1 class="mistify__info-title">' + _.props.elem.find('.mistify__slide:nth-child(' + (i + 1) + ') .mistify__slide-title').html() + '</h1>' +
						'<a class="mistify__info-button"  href="'+ _.props.elem.find('.mistify__slide:nth-child(' + (i + 1) + ') .mistify__info-button').attr('href') + '">' + _.props.elem.find('.mistify__slide:nth-child(' + (i + 1) + ') .mistify__info-button').html() + '</a>' +
					'</a>' +
				'</li>';
	...
	Mistify.prototype.preloadMasks = function() {
		...
		var masks = ['/assets/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-1.png', '/assets/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-2.png', '/assets/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-3.png', '/assets/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-4.png']
